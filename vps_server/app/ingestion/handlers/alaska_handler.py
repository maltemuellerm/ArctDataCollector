"""Alaska ASOS station observation handler.

Reads alaska_stations.yaml and fetches observations from the IEM ASOS API
for each active station. Persists results as CSV (one file per station,
...
from ingestion.sources.alaska import fetch_alaska
