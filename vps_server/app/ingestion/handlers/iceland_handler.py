"""Iceland (IMO) station handler.

Reads iceland_stations.yaml and fetches observations from the Icelandic
Meteorological Office open data API for each active station.
"""
...
from ingestion.sources.iceland import fetch_iceland
