"""Finland (FMI) station handler.

Reads finland_stations.yaml and fetches observations from the FMI
Open Data WFS for each active station.
"""
...
from ingestion.sources.finland import fetch_finland
